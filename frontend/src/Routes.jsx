...
function Routers() {
        ...
        try {
          if (students[id-1]) {
            ...
            setStudents(prevStudents => {
              const updatedStudents = prevStudents.filter((student, index) => index !== (id-1));
    ...
    return (
      ...
      <Routes>
        ...
        <Route path="/students" element={<Users students={students} onDeleteRow={handleDeleteRow} alter={handleOpenModal}/>} />
      </Routes>
      {selectedUser && <ModalUnstyled user={selectedUser} onCloseModal={() => setSelectedUser(null)} />}
      </>
    );
  }
